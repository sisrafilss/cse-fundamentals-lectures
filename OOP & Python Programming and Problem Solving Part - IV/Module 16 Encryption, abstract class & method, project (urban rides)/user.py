...
driver1 = Driver("driver1", "driver1@gmail.com", "driver1", randint(0, 30), 9872392)
driver1.take_driving_test()
driver1.register_a_vehicle("car", 1234, 10)
print("")

driver2 = Driver("driver2", "driver2@gmail.com", "driver2", randint(0, 30), 345343)
driver2.take_driving_test()
driver2.register_a_vehicle("car", 1234, 10)
print("")

driver3 = Driver("driver3", "driver3@gmail.com", "driver3", randint(0, 30), 343453)
driver3.take_driving_test()
driver3.register_a_vehicle("car", 1234, 10)
print("")

driver4 = Driver("driver4", "driver4@gmail.com", "driver4", randint(0, 30), 536354)
...
uber.find_a_vehicle(rider1, 'car', 70)
